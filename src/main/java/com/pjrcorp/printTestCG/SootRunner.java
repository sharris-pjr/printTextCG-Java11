...
public class SootRunner
{
    ...
    public static void main(String[] args)
    {
        ...
        printCallGraph(outputDir, entryPointClass, entryPointMethod);
    ...
    public static void printCallGraph(Path outputDir, String entryPointClass, String entryPointMethod)
    {
        String cp = "/tmp/cp";
        ...
        List<String> sootClasspaths = new ArrayList<String>();
        sootClasspaths.add(cp);

        Options.v().set_process_dir(sootClasspaths);
